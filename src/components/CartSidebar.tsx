  ...
  return (
    <>
      ...
      <div className="fixed right-0 top-0 h-full w-full sm:w-96 bg-white dark:bg-gray-800 shadow-2xl z-50 transform transition-transform duration-300 overflow-y-auto">
        <div className="sticky top-0 bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-700 dark:to-purple-700 text-white p-6 shadow-lg z-10">
                ...
                {cartItems.map((item) => (
                  ...
                  >
                    <img
                      ...
                      alt={item.name}
                      className="w-20 h-20 object-cover rounded-lg flex-shrink-0 bg-gray-200 dark:bg-gray-600"
                      onError={(e) => {
